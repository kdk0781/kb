...
document.addEventListener('keypress', function (e) {
  ...
  var customOpen   = document.getElementById('customModal')?.style.display   === 'flex';
  var settingsOpen = document.getElementById('settingsModal')?.style.display === 'flex';
...
function saveSettingsFromModal() {
  ...
  var newPhone  = document.getElementById('setNewPhone')?.value.trim() ?? '';
